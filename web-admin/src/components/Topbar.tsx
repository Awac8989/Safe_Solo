    ...
    <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-border bg-background/80 px-4 backdrop-blur">
      ...
      <div className="ml-auto flex items-center gap-3">
        <div className="hidden items-center gap-2 rounded-md border border-border bg-card px-2 py-1 text-xs text-muted-foreground md:flex">
          ...
          <span>Search incidents, users, hospitals…</span>
        </div>
        ...
        <div className="flex items-center gap-2 rounded-md border border-border bg-card px-2 py-1">
          ...
          <div className="text-xs">
            <div className="font-medium leading-none">Dispatcher 01</div>
            <div className="text-[10px] text-muted-foreground">Shift A · HCMC</div>
          </div>
        </div>
      </div>
    </header>
